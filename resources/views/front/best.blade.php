<!-- small product of the page -->
			<section class="small-product container">
				<div class="row">
					<div class="row">
						<center><h3 class="heading5">Best Sellers</h3></center>
						<!-- feature col of the page -->
						<div class="feature-col feature-col2 col-xs-12 col-md-4 col-xs-12 col-sm-4">
							<div class="img-holder text-center pull-left">
								<a href="shop-detail.html"><img src="{{url('images/Penne_P.jpg')}}" alt="image description" class="img-responsive"></a>
							</div>
						...
						<div class="feature-col feature-col2 col-xs-12 col-md-4 col-xs-12 col-sm-4">
							<div class="img-holder text-center pull-left">
								<a href="shop-detail.html"><img src="{{url('images/pizza.png')}}" alt="image description" class="img-responsive"></a>
							</div>
							<div class="txt-wrap pull-left">
