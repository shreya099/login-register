 ...
 @section('content')<div class="col-sm-6"><h1>Category Table</h1> </div><br>
<head><!-- DataTables -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{url('submitdata')}}" method="POST" id="logForm" enctype="multipart/form-data">
{{ csrf_field() }}
...
<div class="modal-footer">
 ...
 <td>{{$x->id}}</td>
          ...
          <td>
               ...
               <a href="{{url('admin/edit/'.$x->id)}}"><button class="btn btn-primary text-white">edit</button></a>
            <a href="{{url('admin/delete/'.$x->id)}}"><button class="btn btn-primary text-white">delete</button></a>
        </td>
